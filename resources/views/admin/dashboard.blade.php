...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{asset('Front-end/node_modules/mdi/css/materialdesignicons.min.css')}}">
  <link rel="stylesheet" href="{{asset('Front-end/node_modules/perfect-scrollbar/dist/css/perfect-scrollbar.min.css')}}">
  <!-- endinject -->
  <!-- plugin css for this page -->
  <link rel="stylesheet" href="{{asset('Front-end/node_modules/rickshaw/rickshaw.min.css')}}" />
  <link rel="stylesheet" href="{{asset('Front-end/bower_components/chartist/dist/chartist.min.css')}}" />
  <!-- End plugin css for this page -->
  <!-- inject:css -->
  <link rel="stylesheet" href="{{asset('Front-end/css/style.css')}}">
  <!-- endinject -->
  <link rel="shortcut icon" href="{{asset('Front-end/images/favicon.html')}}" />
</head>
<body class="sidebar-dark">
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="index.html"><img src="{{asset('Front-end/images/salt_logo.svg')}}" alt="Logo"></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
              <img src="{{asset('style/img/faria.PNG')}}" alt="">
            </div>
            <div class="details">
              <p class="user-name">Sultana Faria</p>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/sidebar-hidden.html">ACCE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/sidebar-hidden-overlay.html">EEE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/sidebar-fixed.html">SE</a>
                  </li>
                </ul>
              </div>
            </li>
  ...
  <!-- plugins:js -->
  <script src="{{asset('Front-end/node_modules/jquery/dist/jquery.min.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/popper.js/dist/umd/popper.min.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/bootstrap/dist/js/bootstrap.min.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/perfect-scrollbar/dist/js/perfect-scrollbar.jquery.min.js')}}"></script>
  <!-- endinject -->
  <!-- Plugin js for this page-->
  <script src="{{asset('Front-end/node_modules/flot/jquery.flot.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/flot/jquery.flot.resize.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/flot/jquery.flot.categories.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/flot/jquery.flot.pie.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/rickshaw/vendor/d3.v3.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/rickshaw/rickshaw.min.js')}}"></script>
  <script src="{{asset('Front-end/bower_components/chartist/dist/chartist.min.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/chartist-plugin-legend/chartist-plugin-legend.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/chart.js/dist/Chart.min.js')}}"></script>
  <script src="{{asset('Front-end/node_modules/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
  <!-- End plugin js for this page-->
  <!-- inject:js -->
  <script src="{{asset('Front-end/js/off-canvas.js')}}"></script>
  <script src="{{asset('Front-end/js/hoverable-collapse.js')}}"></script>
  <script src="{{asset('Front-end/js/misc.js')}}"></script>
  <script src="{{asset('Front-end/js/settings.js')}}"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="{{asset('Front-end/js/dashboard_1.js')}}"></script>
